...
public class DoSaveHours extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        //Validazione input
        if(idProgettoStr==null || idProgettoStr.trim().isEmpty()) errorMsg="Progetto non specificato.";
        else if(idTaskStr==null || idTaskStr.trim().isEmpty()) errorMsg="Task non specificato.";
